...
export default function StudentDashboard() {
  ...
  const generateFeeStructureContent = (courseData: any, courseType: string) => {
    ...
    return [
      ...
      // Course Details Header Section
      {
        table: {
          ...
          body: [
            ...
            [
              { text: 'Minimum KCSE Grade:', fontSize: 11, bold: true, border: [false, false, false, false] },
              { text: normalized.minKcseGrade, fontSize: 11, border: [false, false, false, false] }
            ]
          ]
        },
      ...
      { text: `MPESA: PAYBILL NO. 257557, ACCOUNT NO. ${studentInfo?.full_name?.toUpperCase() || 'STUDENT NAME'}`, fontSize: 10, margin: [0, 0, 0, 3] },
      { text: '\n' },
