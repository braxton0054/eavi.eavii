  ...
  return (
    <div className="min-h-screen w-full bg-[#f8faff] font-sans">
      ...
      <Link href="/" className="fixed top-4 left-4 md:top-6 md:left-6 z-50 flex items-center gap-2 px-3 py-2.5 md:px-4 md:py-2 bg-white border border-gray-300 rounded-full text-gray-700 hover:bg-gray-100 shadow-sm transition-all min-w-[44px] min-h-[44px] justify-center font-medium">
        ...
        <span className="text-sm font-medium text-gray-600 inline">← Back to Home</span>
      </Link>
      ...
      <div className="relative z-10 w-full max-w-md mx-auto px-4 py-12 flex items-center justify-center min-h-screen">
        <div className="w-full">
          ...
          <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-lg">
            {error && (
              <div className="mb-4 p-4 rounded-xl bg-red-50 border border-red-200 text-sm text-center text-red-600">
                {error}
              </div>
            )}
            {success && (
              <div className="mb-4 p-4 rounded-xl bg-green-50 border border-green-200 text-sm text-center text-green-700">
                {success}
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              {resetMode === 'login' ? (
                <>
                  ...
                  {/* Campus Selector */}
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-3">Select Campus</label>
