...
- Name: bridge-enrollment.spec.ts >> Bridge Enrollment System >> bridge enrollment tab is visible
- Location: tests\bridge-enrollment.spec.ts:19:7
...
Locator: locator('button:has-text("Bridge Enrollment")')
Expected: visible
Timeout: 5000ms
